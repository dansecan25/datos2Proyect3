...
const router = jsonServer.router('tempServer/db.json');
...
server.use('/users', (req: { headers: { authorization: string }; query: { bypassAuth: string } }, res: { sendStatus: (arg0: number) => void }, next: () => void) => {
